...
//import userLogin1 from '../Images/userLogin1.jpg';
//import userregi2 from '../Images/userregi2.jpg';
...
class Profile extends Component {
    ...
    // }
      ...
      componentDidMount(){
        userService.findByUserName(this.state.userName).then((res)=>{
          let user=res.data;
          console.log(user);
          this.setState({
            userId:user.userId,
  ...
  cancel = () => {
       this.props.history.push(`/userHome/${this.state.user_id}`)
  }
  saveCustomer =(e) =>{
    e.preventDefault();
   ...
   userService.updateUser(user.userName,user).then((res)=>{
...
render() {
 ...
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        ...
        <a class="nav-link"  href={`/ClientHome/${this.state.userName}`}> Home</a>
        </li>
        <li class="nav-item">
          ...
          <a class="nav-link" href="/medicines"> Medicines </a>
               ...
               <div className="container" style={{opacity:"0.7", width:"450px",height:"400px"}}>
                    <div className="row" style={{ 
                        ...
                        <Form className="register-form" style={{textAlign:"left"}} >
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-sm" name="firstName" placeholder=" user First Name" value={this.state.firstName}
                             ...
                             <div class="mb-3 row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control form-control-sm" name="lastName" placeholder="user Last Name" value={this.state.lastName}
                ...
                pattern="[+-]?\d+(?:[.,]\d+)?" required placeholder=" Phone Number" value={this.state.contactNo}
                            ...
                            <div>
                                <Button variant="success" type="submit" onClick={this.saveCustomer} disabled={(this.state.firstName<7)}  style={{ padding: "7px 50px", marginLeft: "30px",marginTop:"-25px" }}>  Update </Button>{' '}
